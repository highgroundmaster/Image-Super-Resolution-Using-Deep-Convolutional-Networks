...
# Note: all dct related functions are either exactly as or based on those at https://github.com/zh217/torch-dct
def dct(x, norm=None):
...
def dct_2d(x, norm=None):
    ...
    """
        ...
        return: the
            DCT-II of the signal over the last 2 dimensions
    """
...
def zoom_in_rec(input, ax, rect, cmap):
    ...
    # Specify the limits
    x1, x2, y1, y2 = rect.get_x(), rect.get_x()+rect.get_width(),rect.get_y(), rect.get_y()+rect.get_height()
